...
export default function ApprovalsList() {
  ...
  const allRequests = [
    { id: '5678', name: 'Back to School Promo', brand: 'Nike, India', owner: 'John Doe', type: 'Fixed Slot', submitted: 'May 26, 2026 | 10:42', boards: 4 },
    { id: '5679', name: 'Samsung Fold Reveal',   brand: 'Samsung',     owner: 'Ruth Price', type: 'Multi-slot',  submitted: 'May 25, 2026 | 16:08', boards: 2 },
    { id: '5680', name: 'Netflix Stranger Things 5', brand: 'Netflix', owner: 'Ruth Price', type: 'Recurring',  submitted: 'May 24, 2026 | 09:15', boards: 6 },
    { id: '5681', name: "McDonald's Breakfast Rush", brand: "McDonald's", owner: 'John Doe', type: 'Fixed Slot', submitted: 'May 23, 2026 | 14:30', boards: 3 },
    { id: '5682', name: 'CRED Cashback Weekender', brand: 'CRED',      owner: 'Ruth Price', type: 'Multi-slot', submitted: 'May 23, 2026 | 11:22', boards: 5 },
    { id: '5683', name: 'Apple Watch Series X Promo', brand: 'Apple',  owner: 'Ruth Price', type: 'Fixed Slot', submitted: 'May 22, 2026 | 17:50', boards: 8 },
    { id: '5684', name: 'Summer Campaign',         brand: 'Coca-Cola', owner: 'John Doe',  type: 'Recurring',  submitted: 'May 21, 2026 | 08:12', boards: 10 },
    { id: '5685', name: 'Nike x SNKRS Drop Launch', brand: 'Nike, India', owner: 'Ruth Price', type: 'Multi-slot', submitted: 'May 20, 2026 | 13:45', boards: 4 },
  ];
  ...
  const toggleAll = () =>
    setSelected((s) =>
      s.size === allRequests.length ? new Set() : new Set(allRequests.map((r) => r.id))
    );

  const FilterBtn = ({ children }) => (
    <button className="inline-flex items-center gap-1.5 px-3.5 py-2 text-sm bg-white border border-gray-200 rounded-md text-gray-700 hover:bg-gray-50">
    ...
    <AppShell>
      ...
      <div className="max-w-[1440px] mx-auto px-8 py-6">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="relative flex-1 max-w-xs">
            ...
            <input
              ...
              className="w-full text-sm bg-white border border-gray-200 rounded-md pl-9 pr-3 py-2 outline-none focus:border-gray-300"
            />
          </div>
          <FilterBtn>Brand</FilterBtn>
          <FilterBtn>Type</FilterBtn>
          <FilterBtn>Owner</FilterBtn>
          <FilterBtn>Submitted</FilterBtn>
        </div>

        {/* Sub toolbar */}
        <div
          className="flex items-center justify-between px-4 py-2.5 rounded-md mb-3"
        ...
        >
          <div className="text-sm text-gray-700">
            {selected.size > 0 ? (
              ...
              <>
                Requests Found: <span className="font-semibold">{allRequests.length}</span>
              </>
            )}
          </div>
          {selected.size > 0 ? (
            <div className="flex items-center gap-2">
              <button className="text-xs font-medium px-3 py-1.5 rounded-md border border-green-500 text-green-600 hover:bg-green-50">
                Approve Selected
              </button>
              <button className="text-xs font-medium px-3 py-1.5 rounded-md border border-red-500 text-red-600 hover:bg-red-50">
                Reject Selected
              </button>
            </div>
          ) : (
            ...
            <thead className="bg-gray-50 text-gray-500 text-xs">
              <tr>
                <th className="w-10 p-3 text-left">
                  <input
                    type="checkbox"
                    checked={selected.size === allRequests.length}
                    onChange={toggleAll}
                  />
                </th>
        ...
        <div className="flex items-center justify-between text-sm text-gray-600 mt-3">
          <div>{selected.size} of {allRequests.length} row(s) selected.</div>
